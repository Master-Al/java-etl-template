...
- `src/main/java/com/project/si/bdd/etl/transform` - (empty, reserved for future).
- `src/main/java/com/project/si/bdd/etl/load` - Simple in-memory loader.
- `src/main/java/com/project/si/bdd/etl/route` - Camel route with inline extract/transform and a load class.
